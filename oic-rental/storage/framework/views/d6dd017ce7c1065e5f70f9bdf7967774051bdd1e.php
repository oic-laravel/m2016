...
<body>
  ...
  <div class="container" style="margin-top:100px; padding:20px 0;">
    ...
    item_number : <?php echo e($row->item_number); ?><br>
    item_name   : <?php echo e($row->item_name); ?>
  ...
  <div>
    <form class="form-horizontal col-md-4 col-md-offset-4" action="#" method="POST">
      <div class="form-group">
        ...
        <div>
        <?php foreach($item as $row): ?>
          <input type="text" id="barcode-value" name="barcode-value" value=<?php echo e($row->item_number); ?> class="form-control">
        <?php endforeach; ?>
        </div>
      </div>
      <div class="form-group">
