    ...
    <div class="col-md-9">
      ...
      <table class="table table-striped table-hover">
        ...
        <tbody>
          <tr>
            <ul class="rentals">
              <?php foreach($lendhistory as $row): ?>
              <tr>
                <td><?php echo e($row->item_name); ?></td>
                <td><?php echo e($row->student_number); ?></td>
                <td><?php echo e($row->rental_date); ?></td>
                ...
                <div style="display:inline-flex">
                  ...
                  <form class="form-horizontal" method="post" action="/lendhistory/delete/<?php echo e($row->rental_id); ?>">
